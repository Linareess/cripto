...
<form name="setupForm" action="index.php" method="post" class="akeeba-form--horizontal">
	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--teal" style="margin-top: 0">
			...
			<?php if (true || version_compare($this->container->session->get('jversion'), '2.5.0', 'ge')): ?>
			<div class="akeeba-form-group">
				<label for="robotHandling"><?= AText::_('SETUP_LBL_ROBOTS_LBL') ?></label>
				<?= AngieHelperSelect::genericlist([
					AngieHelperSelect::option(0, AText::_('SETUP_LBL_ROBOTS_OPT_NO_CHANGE')),
					AngieHelperSelect::option(1, AText::_('SETUP_LBL_ROBOTS_OPT_INDEX_FOLLOW')),
					AngieHelperSelect::option(2, AText::_('SETUP_LBL_ROBOTS_OPT_INDEX_NO_FOLLOW')),
					AngieHelperSelect::option(3, AText::_('SETUP_LBL_ROBOTS_OPT_NO_INDEX_NO_FOLLOW')),
				], 'robotHandling', null, 'value', 'text', $this->robotHandling) ?>
			</div>
			<?php endif ?>
